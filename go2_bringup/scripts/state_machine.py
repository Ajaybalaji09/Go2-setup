...
class BallPatrolNavigator(Node):
    ...
    def __init__(self, navigator: BasicNavigator,
        ...
        # Equivalent to: ros2 service call /play_audio go2_interfaces/srv/Say
        #                "{text: '/path/to/your/file.wav'}"
    ...
    def _amcl_cb(self, msg: PoseWithCovarianceStamped):
        # Store both position and orientation so nav thread has the full pose
    ...
    def _go_to_stop_pose(self, ball_map) -> str:
        ...
        This stops the robot ~where it is when detection fires, with a small
        forward nudge so it doesn't freeze mid-step.  The robot keeps its
        current orientation — no spinning to face the ball.
